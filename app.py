...
# Load model
cnn_model = tf.keras.models.load_model(STATIC_FOLDER + '/' + 'na.h5')
...
def classify(model, image_path):
    ...
    label = "Mèo" if prob[0][0] >= 0.5 else "Chó"
    print(prob[0][0])
    classified_prob = prob[0][0] if prob[0][0] >= 0.5 else 1 - prob[0][0]
    classified_prob = round((classified_prob * 100), 2)
...
def upload_file():
    ...
    if request.method == 'GET':
        ...
        # prob = round((classified_prob * 100), 2)
